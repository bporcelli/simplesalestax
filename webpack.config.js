				...
				use: [
					...
					{ loader: 'css-loader', options: { importLoaders: 1 } },
					{
						...
						options: {
							sassOptions: {
								includePaths: [
									'includes/vendor/woocommerce-blocks/assets/css/abstracts'
								],
							},
	...
	resolve: {
		alias: {
			'@woocommerce/base-components': path.resolve(
				process.cwd(),
				'includes/vendor/woocommerce-blocks/assets/js/base/components',
			),
			'@woocommerce/types': path.resolve(
				process.cwd(),
				'includes/vendor/woocommerce-blocks/assets/js/types',
			),
			'@woocommerce/block-settings': path.resolve(
				process.cwd(),
				'includes/vendor/woocommerce-blocks/assets/js/settings/blocks',
			),
		},
