...
To install Simple Sales Tax, download the latest version of the plugin from WordPress.org and follow the instructions in the [Installation Guide](https://simplesalestax.com/installation-guide/).
