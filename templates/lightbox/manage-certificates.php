...
<head>
  ...
  <link rel="stylesheet" href="<?php echo urldecode($_GET['pluginPath']); ?>css/lightbox.css?v=1" type="text/css" />
...
<body id="manage-certificates">
  ...
  <div id="wootax-loading" class="hidden">
    <p>Fetching Certificates... <img src="<?php echo urldecode($_GET['pluginPath']); ?>img/ajax-loader.gif" /></p>
  </div>
