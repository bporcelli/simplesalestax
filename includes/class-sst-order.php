...
class SST_Order extends SST_Abstract_Cart {
	 ...
	 * @since 5.0
	 */
	public function do_refund( $refund ) {
		// TODO: Support $refund as array of items for back compat.
		$order = $this->order;
		...
		foreach ( $packages as $package ) {
			...
			wc_get_logger()->debug( 'refund items for package: ' . print_r( $refund_items, true ), [ 'source' => 'sst_debug' ] );
